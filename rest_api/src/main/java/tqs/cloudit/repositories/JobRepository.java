...
public interface JobRepository extends CrudRepository<Job, Long> {
    ...
    @Query(value= "select * from job where type='Proposal' and not finished", nativeQuery=true)
    public List<Job> getProposals();
    
    @Query(value="select * from job where title like concat('%',?1,'%') or description like concat('%',?2,'%') and type='Offer' and not finished", nativeQuery = true)
    public List<Job> getJobOffersFromTextOnly(String title, String description);
    
    @Query(value="select * from job where (title like concat('%',?1,'%') or description like concat('%',?2,'%')) and amount >= ?3 and amount <= ?4 and type='Offer' and not finished", nativeQuery = true)
    public List<Job> getJobOffersFromTextAndAmount(String title, String description, double fromAmount, double toAmount);
    
    @Query(value="select * from job where (title like '%?1%'concat('%',?1,'%') or description like concat('%',?2,'%')) and date <= ?3 and date >= ?4 and type='Offer' and not finished", nativeQuery = true)
    public List<Job> getJobOffersFromTextAndDate(String title, String description, String fromDate, String toDate);
    
    @Query(value="select * from job where (title like concat('%',?1,'%') or description like concat('%',?1,'%') or area like concat('%',?2,'%')) and amount >= ?3 and amount <= ?4 and date >= ?5 and date <= ?6 and type='Offer' and not finished", nativeQuery = true)
    ...
    @Query(value="select * from job where (title like concat('%',?1,'%') or description like concat('%',?2,'%')) and amount >= ?3 and amount <= ?4 and date >= ?5 and date <= ?6 and type='Offer' and not finished", nativeQuery = true)
    ...
    @Query(value="select * from job where (title like concat('%',?1,'%') or description like concat('%',?1,'%') or area like concat('%',?2,'%')) and amount >= ?3 and amount <= ?4 and date >= ?5 and date <= ?6 and type='Proposal' and not finished", nativeQuery = true)
    ...
    @Query(value="select * from job where (title like concat('%',?1,'%') or description like concat('%',?2,'%')) and amount >= ?3 and amount <= ?4 and date >= ?5 and date <= ?6 and type='Proposal' and not finished", nativeQuery = true)
    ...
    @Query(value="select * from job where area like concat('%',?1,'%') and amount >= ?2 and amount <= ?3 and date >= ?4 and date <= ?5 and type='Proposal' and not finished", nativeQuery = true)
